 ...
 * @author zkf9688
 */
public class CasTokenRestClient implements Closeable {
    ...
    public CasTokenRestClient(String protocol, String host, int port, String username,
                              String password) {
