...
//    host_cpu_usage("主机CPU利用率", ReportMetricEnum.host_cpu_usage, null,null),
    ...
    disk_iops("磁盘IOPS", ReportMetricEnum.disk_iops, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    disk_latency("查询磁盘读写延迟", ReportMetricEnum.disk_latency, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    ...
    disk_usage("磁盘利用率", ReportMetricEnum.disk_usage, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    net_throughput("网络吞吐量", ReportMetricEnum.net_throughput, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    partition_usage("分区利用率", ReportMetricEnum.partition_usage, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    ...
    host_cpu_TopN("查询主机下虚拟机cpu_topN信息", ReportMetricEnum.host_cpu_TopN, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    host_mem_TopN("查询主机下虚拟机内存topN信息", ReportMetricEnum.host_mem_TopN, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    host_performance("查询主机当前的性能数据", ReportMetricEnum.host_performance, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    host_summary("查询主机当前的概要信息", ReportMetricEnum.host_summary, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    host_overview("查询指定主机的概要信息", ReportMetricEnum.host_overview, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cpu_allocate_rate("主机cpu分配比", ReportMetricEnum.cpu_allocate_rate, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    mem_allocate_rate("主机内存分配比", ReportMetricEnum.mem_allocate_rate, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    ...
    cluster_host_top5_cpu_usage("查询集群下主机cpu_topN信息", ReportMetricEnum.cluster_host_top5_cpu_usage, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cluster_host_top5_mem_usage("查询集群下主机内存topN信息", ReportMetricEnum.cluster_host_top5_mem_usage, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cluster_virt_host_cpu_TopN("查询集群下虚拟机cpu_topN信息", ReportMetricEnum.cluster_virt_host_cpu_TopN, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cluster_virt_host_mem_TopN("查询集群下虚拟机内存topN信息", ReportMetricEnum.cluster_virt_host_mem_TopN, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cluster_cpu_usage("cpu利用率", ReportMetricEnum.cpu_usage, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},ReportSeparateEnum.cluster),
    ...
    disk_rate("存储利用率", ReportMetricEnum.disk_rate, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    connection("虚拟机连接数", ReportMetricEnum.connection, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    cpu_usage_detail("cpu使用情况", ReportMetricEnum.cpu_usage_detail, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
    disk_throughput("磁盘IO吞吐量", ReportMetricEnum.disk_throughput, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),

    health_info("主机健康度信息", ReportMetricEnum.health_info, new ReportResourceEnum[]{ReportResourceEnum.workspace, ReportResourceEnum.cas, ReportResourceEnum.uis},null),
