...
public class HostInfo {
    ...
    /** 是否忽略重复管理 */
    @ApiModelProperty(value="是否忽略重复管理",example="1")
    private Boolean ignore;
    /** 主机的网段地址 */
    @ApiModelProperty(value="主机的网段地址",example="1")
    private String netAddr;
    /** 组播地址 */
    @ApiModelProperty(value="组播地址",example="1")
    private String mcNetAddr;
    /** 端口 */
    @ApiModelProperty(value="端口",example="1")
    private String mcPort;
    /** CPU周期最小限制 */
    @ApiModelProperty(value="CPU周期最小限制",example="1")
    private Integer cpuMinRate;
    /** CPU周期最大限制 */
    @ApiModelProperty(value="CPU周期最大限制",example="1")
    private Integer cpuMaxRate;
    /** 主机所在主机池名称 */
    @ApiModelProperty(value="主机所在主机池名称",example="1")
