...
public interface ErrorCodes {
    ...
    //用户注册审批：1321 - 1350
    int USERNAME_ALREADY_EXISTS = 1321;
    int USERNAME_BLANK = 1322;
    int PASSWORD_NOT_MATCH = 1323;
    int REGISTRATION_NOT_FOUND = 1324;
    int REGISTRATION_ALREADY_PROCESSED = 1325;
    int USER_INACTIVE = 1326;
    int REGISTRATION_SUCCESS_WAIT_APPROVAL = 1327;
