 ...
 */
public class WsTokenRestClient implements Closeable {
    ...
    public WsTokenRestClient(String protocol, String host, int port, String username,
                             String password) {
