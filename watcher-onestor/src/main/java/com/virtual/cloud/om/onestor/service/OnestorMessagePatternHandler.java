...
@Component
public class OnestorMessagePatternHandler extends DefaultLogPatternHandler implements LogPatternApi {

    private static final String pattenExp = "([^\\[\\]]*)\\s([\\d\\:]*)\\s([^\\[\\]]*)\\s([^\\[\\]]*):(.*)";
    ...
    public Optional<LogLine> parseLine(String message) {
        ...
        if (isFind) {
            ...
            logLine.setHostName(matcher.group(3));
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.onestor_message;
    }
}
