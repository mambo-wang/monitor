...
@Component
public class OnestorCephPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {

    private static final String pattenExp = "([\\d,\\-,\\s\\:]*)(.*)";
    ...
    public Optional<LogLine> parseLine(String message) {
        ...
        if (isFind) {
            ...
            logLine.setMessage(matcher.group(2));
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.onestor_ceph;
    }
}
