...
import com.virtual.cloud.om.sdk.dto.clickhouse.NumbersRecord;
...
public class BigDatasetExamples {
    ...
    public static void main(String[] args) {
        final String endpoint = System.getProperty("chEndpoint", "http://192.168.233.10:8123");
        final String user = System.getProperty("chUser", "default");
        final String password = System.getProperty("chPassword", "Cloud@1234");
