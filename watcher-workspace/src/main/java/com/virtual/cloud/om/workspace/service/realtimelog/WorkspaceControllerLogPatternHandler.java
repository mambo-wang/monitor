 ...
 */
@Component
public class WorkspaceControllerLogPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.workspace_controller;
    }
}
