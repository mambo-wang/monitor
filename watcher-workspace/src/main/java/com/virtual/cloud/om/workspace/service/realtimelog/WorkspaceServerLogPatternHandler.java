 ...
 */
@Component
public class WorkspaceServerLogPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {
    ...
    public Optional<LogLine> parseLine(String message) {
        ...
        if (isFind) {
            ...
            /*logLine.setRequestPort(matcher.group());//无端口数据*/
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.workspace_server;
    }
}
