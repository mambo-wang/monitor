 ...
 */
@Component
public class WorkspaceGrpcLogPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {
    private final String pattenExp = "([^\\[\\]]*)\\[([^\\[\\]]*)\\]\\[([^\\[\\]]*)\\]\\[([^\\[\\]]*)\\]\\[(\\/)([^\\[\\]]*):([^\\[\\]]*)\\]([^\\[\\]]*)\\s+\\[([^\\[\\]]*)\\]\\s+-\\s+([^\\[\\]]*)(.*)";
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.workspace_grpc;
    }
}
