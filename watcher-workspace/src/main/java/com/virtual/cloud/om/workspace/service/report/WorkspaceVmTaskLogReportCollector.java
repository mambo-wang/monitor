...
import com.virtual.cloud.om.sdk.config.token.workspace.WsCasTokenRestConnection;
...
@Slf4j
public class WorkspaceVmTaskLogReportCollector extends DataReportCollector {



    private final WsCasTokenRestConnection wsCasTokenRestConnection;
    ...
    public List<DataValueAndTagsDTO> collect(String platform, String host, String protocol, Integer port, String username, String password, String tags, String resourceId) {
        ...
        Integer limit = 2000;
        Integer offset = 0;
        String uri = String.format(WsUriConstants.Log.OPERATION_LOGS_VM, limit, offset, OperationLogTypeEnum.vm.type);
        RpcResult<List<VmTaskLogDto>> listRpcResult = wsCasTokenRestConnection.get(host, protocol, username, password, port, uri, new ParameterizedTypeReference<RpcResult<List<VmTaskLogDto>>>(){
        }).getBody();
        //根据Id去重
    ...
    public DataReportTypeByMetricEnum metric() {
        return DataReportTypeByMetricEnum.workspace_operation_log;
    }
