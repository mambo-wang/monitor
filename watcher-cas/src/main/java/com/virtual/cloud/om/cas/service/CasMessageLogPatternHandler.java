...
@Component
public class CasMessageLogPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {

    private static final String pattenExp = "([^\\[\\]]*)\\s([\\d\\:]*)\\s(.*)";
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.cas_message;
    }
}
