...
@Component
public class CasCasServerLogPatternHandler extends DefaultLogPatternHandler implements LogPatternApi {

    private static final String pattenExp = "([^\\[\\]]*)\\s+\\[([^\\[\\]]*)\\]\\s+\\[([^\\[\\]]*)\\]\\s+\\[([^\\[\\]]*)\\]\\s+(.*)";
    ...
    public RealTimeLogTypeEnum logType() {
        return RealTimeLogTypeEnum.cas_casserver;
    }
}
