...
@Slf4j
public class ClusterVirtHostMemTopNCollector extends DataReportCollector {
    ...
    protected List<DataValueAndTagsDTO> collect(String platform, String host, String protocol, Integer port, String username, String password, String tags, String resourceId) {
        ...
        if (CollectionUtil.isNotEmpty(clusterIds)) {
            ...
            String url = String.format(CasUriConstants.Cluster.QUERY_CLUSTER_VIRT_HOST_MEM_TOPN, clusterId);
...
//            return virtRateDTOS;
    ...
    public DataReportTypeByMetricEnum metric() {
        return DataReportTypeByMetricEnum.cluster_virt_host_mem_TopN;
    }
