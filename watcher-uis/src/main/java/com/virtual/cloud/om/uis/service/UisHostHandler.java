 ...
 */
@Component
public class UisHostHandler implements HostApi {
    ...
    public SSHHost getHost(RestHost cvmHost, String endpoint) {
        ...
        HostInfo hostInfo = casRestConnection.get(cvmHost.getPlatform(), cvmHost.getHost(), cvmHost.getProtocol(),
                cvmHost.getPort(), cvmHost.getUsername(), cvmHost.getPassword(), url, new ParameterizedTypeReference<HostInfo>() {
                });
