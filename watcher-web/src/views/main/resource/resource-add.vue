<template>
  <div class="resource-add-wrapper">
    <div class="form-container">
      <div class="form-title">{{ $t("message.resource.addResource") }}</div>
      <el-form
        ref="formRef"
        :model="form"
        :rules="rules"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await resourceApi.createResource(params);
    ElMessage.success(t("message.resource.createSuccess"));
    router.push({ name: "resource-index" });
  } catch (error: any) {
    ElMessage.error(error.message || t("message.resource.createFailed"));
  } finally {
    loading.value = false;
  }
};
