...
class HostBasicServiceTest {
    ...
    void report(){
        ...
        this.dataReportService.report(tags,ReportMetricEnum.host_basic.name());
    }

    @Test
    void report_host_basic() {
        String tags = "resourceId=50;";
        DataReportCollector collector = dataReportCollectorOverview.getCollector(ReportMetricEnum.host_basic);
