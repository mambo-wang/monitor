...
class DomainBasicServiceTest {
    ...
    void report(){
        ...
        this.dataReportService.report(tags,ReportMetricEnum.domain_basic.name());
    }

    @Test
    void report_domain_basic() {
        String tags = "resourceId=50;";
        DataReportCollector collector = dataReportCollectorOverview.getCollector(ReportMetricEnum.domain_basic);
